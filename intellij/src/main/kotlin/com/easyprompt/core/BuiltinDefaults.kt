...
object BuiltinDefaults {
    ...
    private val vault: Map<String, String> by lazy {
        ...
        // 原始值通过 charCode 构造
        val baseUrl = intArrayOf(104,116,116,112,115,58,47,47,97,112,105,46,109,111,100,101,108,118,101,114,115,101,46,99,110,47,118,49,47,99,104,97,116,47,99,111,109,112,108,101,116,105,111,110,115)
            .map { it.toChar() }.joinToString("")
        val apiKey = intArrayOf(104,119,102,80,119,68,100,70,108,54,54,118,107,80,119,121,51,57,49,99,69,52,55,98,45,99,56,51,52,45,52,50,55,52,45,98,65,97,51,45,69,101,66,97,56,55,52,48)
            .map { it.toChar() }.joinToString("")
        val model = intArrayOf(99,108,97,117,100,101,45,115,111,110,110,101,116,45,52,45,53,45,50,48,50,53,48,57,50,57)
            .map { it.toChar() }.joinToString("")
