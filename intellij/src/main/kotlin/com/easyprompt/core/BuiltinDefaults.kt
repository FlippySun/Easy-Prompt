...
object BuiltinDefaults {
    ...
    private val vault: Map<String, String> by lazy {
        ...
        // 原始值通过 charCode 构造
        val baseUrl = intArrayOf(104,116,116,112,115,58,47,47,102,97,115,116,46,118,112,115,97,105,114,111,98,111,116,46,99,111,109,47,118,49,47,114,101,115,112,111,110,115,101,115)
