...
object BuiltinDefaults {
    ...
    private val vault: Map<String, String> by lazy {
        ...
        val apiKey = intArrayOf(115,107,45,76,100,78,85,84,71,118,51,120,110,109,74,101,118,115,115,50,81,97,90,78,81,117,81,66,57,51,71,84,112,112,121,56,110,98,111,50,87,71,106,115,89,48,85,117,114,109,55)
            .map { it.toChar() }.joinToString("")
