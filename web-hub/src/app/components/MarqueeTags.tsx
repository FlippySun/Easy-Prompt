    ...
    <div className="relative overflow-hidden py-1" aria-hidden>
      ...
      <div className="marquee-track flex gap-2">
        {doubled.map((tag, i) => (
          <span
            key={i}
            className={`inline-flex shrink-0 cursor-pointer items-center gap-1 rounded-xl border px-3 py-1.5 text-[11px] font-medium backdrop-blur-sm transition-colors ${tagCls}`}
          >
